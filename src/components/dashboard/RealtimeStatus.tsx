        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`text-sm font-black italic tracking-tighter ${hasData ? 'text-white' : 'text-gray-500'}`}>
              {hasData ? 'CONNECTED LIVE' : 'TUNING IN...'}
        ...
        {hasData && (
          <div className="flex gap-4 ml-auto border-l border-white/10 pl-4 items-center">
            ...
            <div className="flex flex-col items-center">
              <span className="text-[9px] text-gray-500 font-bold uppercase tracking-widest">PRESSURE</span>
            ...
            {/* Hype/Coin Indicator */}
            <div className="flex flex-col items-center">
              <span className="text-[9px] text-gray-500 font-bold uppercase tracking-widest">THE ROAR</span>
